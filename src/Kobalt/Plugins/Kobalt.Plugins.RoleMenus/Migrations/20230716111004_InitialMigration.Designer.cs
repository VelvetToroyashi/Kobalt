...
namespace Kobalt.Plugins.RoleMenus.Migrations
{
    ...
    [Migration("20230716111004_InitialMigration")]
...
#pragma warning disable 612, 618
            modelBuilder
                .HasDefaultSchema("kobalt_plugins_rolemenu")
            ...
            modelBuilder.Entity("Kobalt.Plugins.Core.Data.Entities.Guild", b =>
                {
                    ...
                    b.ToTable("guilds", "kobalt_core", t =>
                        {
            ...
            modelBuilder.Entity("Kobalt.Plugins.Core.Data.Entities.GuildAntiRaidConfig", b =>
                {
                    ...
                    b.ToTable("guild_anti_raid_configs", "kobalt_core", t =>
                        {
                            t.ExcludeFromMigrations();
                        });
                });
            ...
            modelBuilder.Entity("Kobalt.Plugins.Core.Data.Entities.GuildAutoModConfig", b =>
                {
                    ...
                    b.ToTable("guild_automod_configs", "kobalt_core", t =>
                        {
                            t.ExcludeFromMigrations();
                        });
                });
            ...
            modelBuilder.Entity("Kobalt.Plugins.Core.Data.Entities.GuildPhishingConfig", b =>
                {
                    ...
                    b.ToTable("guild_phishing_configs", "kobalt_core", t =>
                        {
                            t.ExcludeFromMigrations();
                        });
                });
            ...
            modelBuilder.Entity("Kobalt.Plugins.Core.Data.Entities.GuildUserJoiner", b =>
                {
                    ...
                    b.ToTable("guild_user_joiners", "kobalt_core", t =>
                        {
                            t.ExcludeFromMigrations();
                        });
                });
            ...
            modelBuilder.Entity("Kobalt.Plugins.Core.Data.Entities.LogChannel", b =>
                {
                    ...
                    b.ToTable("log_channels", "kobalt_core", t =>
                        {
                            t.ExcludeFromMigrations();
                        });
                });
            ...
            modelBuilder.Entity("Kobalt.Plugins.Core.Data.Entities.User", b =>
                {
                    ...
                    b.ToTable("Users", "kobalt_core", t =>
                        {
                            t.ExcludeFromMigrations();
                        });
                });

            modelBuilder.Entity("Kobalt.Plugins.RoleMenus.Models.RoleMenuEntity", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                    ...
                    b.ToTable("role_menus", "kobalt_plugins_rolemenu");
                });

            modelBuilder.Entity("Kobalt.Plugins.RoleMenus.Models.RoleMenuOptionEntity", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                    ...
                    b.ToTable("role_menu_options", "kobalt_plugins_rolemenu");
                });
            ...
            modelBuilder.Entity("Kobalt.Plugins.RoleMenus.Models.RoleMenuOptionEntity", b =>
                {
                    b.HasOne("Kobalt.Plugins.RoleMenus.Models.RoleMenuEntity", "RoleMenu")
                        .WithMany("Options")
